...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        return (self.startingPosition, initial_visited_corners)
    ...
    def isGoalState(self, state: Any):
        ...
        """
        "*** YOUR CODE HERE ***"
        visited_corners = state[1]  # state 1 mean there's is goal
    ...
    def getSuccessors(self, state: Any):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:
                ...
                successor_state = (next_position, tuple(new_v_c))
...
def foodHeuristic(state: Tuple[Tuple, List[List]], problem: FoodSearchProblem):
    ...
    This heuristic is the maximum maze distance from the current position to any
    remaining food. It is admissible because the agent must travel at least

    that far to eat the farthest food dot. It uses a cache stored in
    problem.heuristicInfo to avoid recomputing maze distances.
    """
    ...
    cache = problem.heuristicInfo['distance_cache']

    max_dist = 0
    for food_pos in foodList:
        pair = (position, food_pos)
